      ...
      <footer class="text-gray-600 body-font">
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                <div class="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                  <label
                    for="footer-field"
                    class="leading-7 text-sm text-gray-700 font-bold text-xl"
                  >
                    MediSheba
                  </label>
                  <input
                ...
                <button class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-cyan-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">
                  Subscribe
                </button>
              </div>
              <p class="text-gray-500 text-sm mt-2 md:text-left text-center">
                Subscribe to MediSheba
                <br class="lg:block hidden" />
                And get the latest information about Medical techonlogy.
              </p>
            </div>
          </div>
        </div>
        <div class="bg-gray-100">
          <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <span class="ml-3 text-xl">MediSheba</span>

            <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">
              © 2022 @DevTeam55
            </p>
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
              <a href="#nothing" class="text-gray-500">
                <svg
                  fill="currentColor"
              ...
              <a href="#nothing" class="ml-3 text-gray-500">
                <svg
                  fill="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
